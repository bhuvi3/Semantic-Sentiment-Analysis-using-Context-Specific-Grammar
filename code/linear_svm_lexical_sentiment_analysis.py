...
conf = (SparkConf().setMaster("local[8]").setAppName("lexical_sentiment_analysis_linear_svm").set("spark.executor.memory", "1g"))
...
res_fh = open('../result/linear_svm_result.txt','w')
res_fh.write(result)
res_fh.close()
