...
conf = (SparkConf().setMaster("local[8]").setAppName("lexical_sentiment_feature_extraction").set("spark.executor.memory", "1g"))
...
def feature_mapper(x):
    ...
    feature_values = pos_values + neg_values + lex_score_complex_feature + class_polarity
...
#writing to file
out = open("../imdb/supervised/featurized_lexical_analyzed_data.csv",'wb')
...
#writing to file
out = open("../imdb/supervised/featurized_lexical_analyzed_data_weka.csv",'wb')
#out = open("../imdb/unsupervised/featurized_lexical_supervised_data.csv",'wb')
#out = open("../imdb/train/featurized_lexical_analyzed_train_data.csv",'wb')
#out = open("../imdb/test/featurized_lexical_analyzed_test_data.csv",'wb')
